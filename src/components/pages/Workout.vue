<script setup>
  ...
  // let selectedExercise = null // this wont work because we need stateful variables so that the ui knows it needs to rerender to reflect any changes in the javascript
